...
(function($) {
  ...
  Sketch = (function() {
    ...
    Sketch.prototype.onEvent = function(e) {
      if (device.platform == 'Android' && e.type.substr(0,5) == 'mouse'){
          //some androids throw duplicate events and the mouse ones are unusable.
          //do nothing
          e.preventDefault();
          return false;
      }
    ...
    Sketch.prototype.redraw = function() {
      ...
      if (this.painting && !$.isEmptyObject(this.action)) {
    ...
    Sketch.prototype.val = function(value){
        if (value){
