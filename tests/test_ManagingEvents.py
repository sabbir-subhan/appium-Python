...
class TestManagingEvents(SetupTestCase):
    ...
    def tearDown(self):
        ...
        self.driver.save_screenshot(PROJECT_ROOT + "/screenshots/test_ManagingEvents.png")
    ...
    def test_ManagingEvents(self):
        ...
        events_page.fill_Name_input_field("First_event")
        ...
        main_page.open_EVENTS()
        events_page.clear_Search_field()
        events_page.type_text_into_search_field("First_event")
        common_page.click_Return_button_on_keyboard()
        common_page.hide_keyboard()
        ...
        events_page.click_New_event_button()
        events_page.choose_Incident_type_of_event()
        events_page.fill_Name_input_field("Second_event")
        events_page.click_severity_lvl_picker()
        ...
        main_page.open_EVENTS()
        events_page.clear_Search_field()
        events_page.type_text_into_search_field("Second_event")
        common_page.click_Return_button_on_keyboard()
        common_page.hide_keyboard()
        events_page.open_previously_created_event()
        common_page.wait_for_app_loading()
        ...
        events_page.choose_Incident_type_of_event()
        events_page.fill_Name_input_field("Appium_sub_event")
        events_page.click_severity_lvl_picker()
