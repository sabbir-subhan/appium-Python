...
class TestManagingEvents(SetupTestCase):
    ...
    def test_managing_events(self):
        ...
        # events_page.fill_Name_input_field("Appium_first_event")
        ...
        # main_page.open_EVENTS()
        # common_page.clear_Search_field()
        # events_page.type_text_into_search_field("Appium_first_event")
        # common_page.click_Return_button_on_keyboard()
        # common_page.hide_keyboard()
        ...
        events_page.click_New_event_button()
        events_page.choose_Incident_type_of_event()
        events_page.fill_Name_input_field("Appium_second_event")
        events_page.click_severity_lvl_picker()
        ...
        main_page.open_EVENTS()
        common_page.clear_Search_field()
        events_page.type_text_into_search_field("Appium_second_event")
        common_page.click_Return_button_on_keyboard()
        common_page.hide_keyboard()
        events_page.open_previously_created_event()
        events_page.click_edit_button()
