...
class TestCase9Android(unittest.TestCase):
    def setUp(self):
    ...
    def test_Quick_Access_buttons(self):
        ...
        safari_page = ChromeBrowserPage(self.driver)
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(TestCase9Android)
