...
class test_QuickAccessButtons_Android(unittest.TestCase):
    def setUp(self):
    ...
    def test_Quick_Access_buttons(self):
        ...
        new_task_page.type_title("Title for new task test - android")
        android_device.hide_keyboard()
        ...
        new_report_page.type_title("Title for new report test - android")
        android_device.hide_keyboard()
        ...
        android_device.click_back_button()  # Appium can't switch between apps so this click is based on coordinates
        main_page.check_presence_of_events_button()
        ...
        new_log_page.scroll_down_one_view()
...
if __name__ == '__main__':
    suite = unittest.TestLoader().loadTestsFromTestCase(test_QuickAccessButtons_Android)
