...
class TestAssets(SetupTestCase):
    ...
    def tearDown(self):
        ...
        self.driver.save_screenshot(PROJECT_ROOT + "/screenshots/test_Assets.png")
    ...
    def test_Assets(self):
        ...
        assets_page.choose_asset_type()
        assets_page.fill_Name_input_field("Map_asset")
        assets_page.scroll_down_to_save_button()
        assets_page.click_save_button()
        common_page.check_popup_about_unfilled_fields()
        common_page.wait_for_app_loading()
        ...
        # Click on Assets > Search Assets
        main_page.open_ASSETS()
        assets_page.type_text_into_search_field("Map_asset")
