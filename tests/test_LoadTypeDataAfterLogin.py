...
class TestLoadTypeDataAfterLogin(SetupTestCase):
    ...
    def tearDown(self):
        ...
        self.driver.save_screenshot(PROJECT_ROOT + "/screenshots/test_Load_Type_Data_After_Login.png")
    ...
    def test_Load_Type_Data_After_Login(self):
        ...
        events_page.fill_Name_input_field("offline_mode")
        ...
        events_page.type_text_into_search_field("offline_mode")
