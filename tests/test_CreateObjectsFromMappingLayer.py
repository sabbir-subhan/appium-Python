...
class TestCreateObjectsFromMappingLayer(SetupTestCase):
    ...
    def test_create_objects_from_mapping_layer(self):
        ...
        # common_page.click_Return_button_on_keyboard()
        # common_page.hide_keyboard()
        # tasks_page.open_existing_task()
        # common_page.wait_for_app_loading()
        # tasks_page.check_if_view_on_map_button_is_present()
        # common_page.hamburger_button()
        # main_page.check_presence_of_inbox_button()
        #
        # # Click on Event > Create a new event > Click on Create mapping data >
        # # Click on Tool > Add Geometry > Save map -> Edit event > Click on mapping data > Click on Geometry > View attributes
        ...
        # events_page.choose_Incident_type_of_event()
        # events_page.fill_Name_input_field("Event with map")
        # events_page.click_severity_lvl_picker()
        # events_page.choose_severity_level_1()
        # events_page.scroll_down_to_save_button()
        ...
        # main_page.open_EVENTS()
        # events_page.clear_Search_field()
        # events_page.type_text_into_search_field("Event with map")
        # common_page.click_Return_button_on_keyboard()
        # common_page.hide_keyboard()
        # events_page.open_previously_created_event()
        # common_page.wait_for_app_loading()
        ...
        map_page.click_on_added_geometry()
        ...
        map_page.press_and_drag_duplicated_geometry()
        common_page.hamburger_button()
        main_page.check_presence_of_events_button()
