...
class TestCreateObjectsFromMappingLayer(SetupTestCase):
    ...
    def test_create_objects_from_mapping_layer(self):
        ...
        common_page.alert_popup_allow()  # for tests

        map_page.wait_for_map_to_load()
        map_page.click_plot_button()
        map_page.click_tool_button()

        map_page.click_point_button()  # for tests
        ...
        map_page.drag_and_drag_duplicated_geometry()
        common_page.hamburger_button()
        main_page.check_presence_of_events_button()

        common_page.swipe_up()  # for tests
        common_page.swipe_down()  # for tests
