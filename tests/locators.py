...
class EventEditScreen(object):
    ...
    CHOOSE_SEVERITY_LVL1_iPad = (By.XPATH, '//UIATableCell[@name="Severity 1"]')
    CHOOSE_SEVERITY_LVL1_iPhone = (By.XPATH, '//UIAPicker/UIAPickerWheel[@value="Severity 1"]')
    CHOOSE_SEVERITY_LVL2 = (By.XPATH, '//android.widget.CheckedTextView[@text="Severity 2"]')
    CHOOSE_SEVERITY_LVL2_iPad = (By.XPATH, '//UIATableCell[@name="Severity 2"]')
    CHOOSE_SEVERITY_LVL2_iPhone = (By.XPATH, '//UIAPicker/UIAPickerWheel[@value="Severity 2"]')
    CHOOSE_SEVERITY_LVL3 = (By.XPATH, '//android.widget.CheckedTextView[@text="Severity 3"]')
    CHOOSE_SEVERITY_LVL3_iPad = (By.XPATH, '//UIATableCell[@name="Severity 3"]')
    CHOOSE_SEVERITY_LVL3_iPhone = (By.XPATH, '//UIAPicker/UIAPickerWheel[@value="Severity 3"]')
    ...
    FIELD_TO_RESTORE_2_VALUE = (By.XPATH, '//android.widget.EditText[@content-desc="test@noggin.com"]')
    FIELD_TO_RESTORE_2_VALUE_ios = (By.XPATH, '//UIATextField[@value="test@noggin.com"]')
