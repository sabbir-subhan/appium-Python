...
class TestRisk(SetupTestCase):
    ...
    def tearDown(self):
        ...
        self.driver.save_screenshot(PROJECT_ROOT + "/screenshots/test_Risk.png")
    ...
    def test_Risk(self):
        ...
        risks_page.type_name_for_new_risk_register('New_risk_register')
        ...
        risks_page.type_name_for_new_context('New_context')
        common_page.hide_keyboard()
        risks_page.scroll_down_to_save_button()
        ...
        risks_page.choose_risk_type_for_test()
        risks_page.type_name_for_new_risk('New_risk')
        common_page.hide_keyboard()
        risks_page.scroll_down_to_save_button()
