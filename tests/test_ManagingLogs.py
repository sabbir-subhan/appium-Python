...
class TestManagingLogs(SetupTestCase):
    ...
    def tearDown(self):
        ...
        self.driver.save_screenshot(PROJECT_ROOT + "/screenshots/test_ManageLogs.png")
    ...
    def test_ManageLogs(self):
        ...
        logs_page.type_text_into_entry_field_all_fields("all fields")
        common_page.hide_keyboard()
        ...
        logs_page.type_text_into_entry_field_all_fields("Appium log with all fields")
        common_page.hide_keyboard()
        logs_page.scroll_down_to_save_button()
        logs_page.click_save_new_log()
        common_page.check_popup_about_unfilled_fields()
        ...
        logs_page.choose_lodging_agency()
        logs_page.scroll_down_to_entry_field()
        logs_page.type_text_into_entry_field_chooser_fields("chooser fields")
        common_page.hide_keyboard()
        logs_page.scroll_down_to_save_button()
        logs_page.click_save_new_log()
        common_page.check_popup_about_unfilled_fields()
