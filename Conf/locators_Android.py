...
class TypesOfEventsScreen:
    ...
    EVENT_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "event_with_rich_text")]]')
...
class Map:
    ...
    MAP_LAYER_FOR_APPIUM = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "map_layer_for_appium")]]')
...
class ContactsScreen:
    ...
    NEW_CONTACT_GROUP_TYPE_CONTACT_GROUP_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "contact_group_with_rich_text")]]')
    CONTACT_TYPE_CONTACT_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "contact_with_rich_text")]]')
...
class ReportsScreen:
    ...
    REPORT_TYPE_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "report_with_rich_text")]]')
...
class LogsScreen:
    ...
    LOG_TYPE_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "log_with_rich_text")]]')
...
class AssetsScreen:
    ...
    ASSET_TYPE_WITH_RICH_TEXT = (MobileBy.XPATH, '//android.view.View[@content-desc[contains(., "asset_with_rich_text")]]')
