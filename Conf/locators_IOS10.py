...
class TypesOfEventsScreen:
    ...
    EVENT_FOR_ALL_FIELDS = (MobileBy.XPATH, '//XCUIElementTypeLink[@name[contains(., "event for all fields")]]')
    EVENT_WITH_RICH_TEXT = (MobileBy.XPATH, '//XCUIElementTypeLink[@name[contains(., "event_with_rich_text")]]')
...
class ReportsScreen:
    ...
    REPORT_TYPE_WITH_RICH_TEXT = (MobileBy.XPATH, '//XCUIElementTypeLink[@name[contains(., "report_with_rich_text")]]')
...
class LogsScreen:
    ...
    # ENTRY_FIELD_BY_XPATH = (MobileBy.XPATH, '//XCUIElementTypeOther[@name[contains(., "Rich Text Editor, entry")]]')  TEST
    ...
    LOG_TYPE_WITH_RICH_TEXT = (MobileBy.XPATH, '//XCUIElementTypeLink[@name[contains(., "log_with_rich_text")]]')
...
class AssetsScreen:
    ...
    NEW_PHONE_NUMBER = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="+61212345111" and @enabled="true"]')
    NEW_FAX_NUMBER = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="+61212345222" and @enabled="true"]')
    NEW_EMAIL_ADDRESS = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="testbitnoise@gmail.com" and @enabled="true"]')
    ...
    NEW_MULTI_LINE_TEXT_DISABLED = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="test_appium_multi_line" and @enabled="false"]')
    NEW_PHONE_NUMBER2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="+61212345333" and @enabled="true"]')
    NEW_FAX_NUMBER2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="+61212345444" and @enabled="true"]')
    NEW_EMAIL_ADDRESS2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="testbit@wp.pl" and @enabled="true"]')
    NEW_WEBSITE_ADDRESS2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="http://www.bitnoi.se" and @enabled="true"]')
    NEW_SINGLE_LINE_TEXT2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="test_appium_single_line2" and @enabled="true"]')
    NEW_MULTI_LINE_TEXT2 = (MobileBy.XPATH, '//XCUIElementTypeTextField[@value="test_appium_multi_line2" and @enabled="true"]')
