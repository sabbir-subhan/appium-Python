...
class EventsScreen:
    ...
    RICH_TEXT_IFRAME_VIEW_EVENT = (MobileBy.CSS_SELECTOR, 'div#emeView>div.ui-content>ul.ui-listview>li>div.iframe>iframe')
...
class EventEditScreen:
    ...
    OPTION_LIST_READ_ONLY = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li[name="is read only ?"]>div.ui-select>div.ui-btn')
    OPTION_LIST_READ_ONLY_EDIT = (MobileBy.CSS_SELECTOR, 'div#emeEdit>div.ui-content>ul.edit-view>li[name="is read only ?"]>div.ui-select>div.ui-btn')
    NEW_DATE_OPTIONAL_TIME_DISABLED = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li>div.ui-input-text>input[id="new date & optional time"]:disabled')
    ...
    NEW_PHONE_NUMBER = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li>div.ui-input-text>input[id="new phone number"]')
    NEW_SINGLE_LINE_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new single-line text2"]')
    NEW_PHONE_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new phone number2"]')
    NEW_MULTI_LINE_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>textarea[id="new multi-line text2"]')
    NEW_FAX_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new fax number2"]')
    NEW_MOBILE_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new mobile number2"]')
    NEW_EMAIL_ADDRESS2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new email address2"]')
    NEW_RICH_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-ckeditor>div[id="cke_new rich text2"]>div.cke_inner>div#cke_2_contents>iframe[title="Rich Text Editor, new rich text2"]')
    NEW_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#emeNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new number2"]')
...
class ContactsScreen:
    ...
    RICH_TEXT_IFRAME_VIEW_CONTACT_GROUP = (MobileBy.CSS_SELECTOR, 'div#contactgroupView>div.ui-content>ul.ui-listview>li>div.iframe>iframe')
    ...
    RICH_TEXT_IFRAME_VIEW_CONTACT = (MobileBy.CSS_SELECTOR, 'div#contactView>div.ui-content>ul.ui-listview>li>div.iframe>iframe')
...
class ReportsScreen:
    ...
    RICH_TEXT_IFRAME_VIEW_REPORT = (MobileBy.CSS_SELECTOR, 'div#reportView>div.ui-content>ul.ui-listview>li>div.iframe>iframe')
    ...
    RICH_TEXT_IFRAME_INSIDE_SUBFORM_VIEW_REPORT = (MobileBy.CSS_SELECTOR, 'div#reportView>div.ui-content>ul.ui-listview>li>div.subform>div.subform-row>ul>li>div.iframe>iframe')
...
class AssetsScreen:
    ...
    OPTION_LIST_READ_ONLY = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li[name="is read only ?"]>div.ui-select>div.ui-btn')
    OPTION_LIST_READ_ONLY_EDIT = (MobileBy.CSS_SELECTOR, 'div#assetEdit>div.ui-content>ul.edit-view>li[name="is read only ?"]>div.ui-select>div.ui-btn')
    ...
    NEW_PHONE_NUMBER_DISABLED = (MobileBy.CSS_SELECTOR,'div.ui-content>ul.edit-view>li>div.ui-input-text>input[id="new phone number"]:disabled')
    NEW_PHONE_NUMBER = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li>div.ui-input-text>input[id="new phone number"]')
    NEW_SINGLE_LINE_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new single-line text2"]')
    NEW_PHONE_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new phone number2"]')
    NEW_MULTI_LINE_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>textarea[id="new multi-line text2"]')
    NEW_FAX_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new fax number2"]')
    NEW_MOBILE_NUMBER2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new mobile number2"]')
    NEW_EMAIL_ADDRESS2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-text>input[id="new email address2"]')
    NEW_RICH_TEXT2 = (MobileBy.CSS_SELECTOR, 'div#assetNew>div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-ckeditor>div[id="cke_new rich text2"]>div.cke_inner>div#cke_2_contents>iframe[title="Rich Text Editor, new rich text2"]')
...
class LogsScreen(EventsScreen, AssetsScreen):
    ...
    RICH_TEXT_IFRAME_VIEW_LOG = (MobileBy.CSS_SELECTOR, 'div#logView>div.ui-content>ul.ui-listview>li>div.iframe>iframe')
    RICH_TEXT_IFRAME_IMAGE_NAME = (MobileBy.CSS_SELECTOR, 'body>p>img[alt="panda.jpg"]')
    RICH_TEXT_IFRAME_IMG_TAG = EventsScreen.RICH_TEXT_IFRAME_IMG_TAG
    # RICH_TEXT_IFRAME_NEW_LOG = (MobileBy.CSS_SELECTOR, 'div#logNew>div.ui-content>ul>li>div.ui-input-ckeditor>div#cke_entry>div.cke_inner>div#cke_1_contents>iframe')
    RICH_TEXT_IFRAME_NEW_LOG = (MobileBy.CSS_SELECTOR, 'div.ui-content>ul.edit-view>li.ui-field-contain>div.ui-input-ckeditor>div#cke_entry>div.cke_inner>div>iframe')
    ENTRY_FIELD_INSIDE_IFRAME_FIRST_P_TAG = (MobileBy.CSS_SELECTOR, 'body>p:first-child')
    ENTRY_FIELD_INSIDE_IFRAME = (MobileBy.CSS_SELECTOR, 'body')
